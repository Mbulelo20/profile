            ...
            <br/>
                ...
                <div className="row container" >
                    <div className="col-md-3">
                        ...
                        <i className="fab fa-js text-center " aria-hidden="true" style={{fontSize: '190px',textAlign: 'center', color: '#4fbfa8', width: '100%',}}/>
                        <hr/>
                    </div>
                    <div className="col-md-3 ">
                        <div className="text-center" style={{color:'grey'}}>
                        ...
                        <i className="fab fa-python " aria-hidden="true" style={{fontSize: '190px', color: 'lightBlue', textAlign: 'center', width: '100%'}}/>
                    ...
                    <div className="col-md-3">
                        ...
                        <i className="fab fa-html5 " aria-hidden="true" style={{fontSize: '190px', color: 'orange', textAlign: 'center', backgroundColor: '#white', width: '100%'}}/>
                        <hr/>
                    </div>
                    <div className="col-md-3 ">
                        <div className="text-center" style={{color:'grey'}}>
